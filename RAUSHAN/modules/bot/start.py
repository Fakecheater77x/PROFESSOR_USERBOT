...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("⚡𝐌ɪss 𝐎ᴡɴᴇʀ💕⚡", url="t.me/pokie_girl"),
            ],
            [
                InlineKeyboardButton("⚡𝐂𝙷𝙰𝙽𝙽𝙴𝙻 💕⚡", url="t.me/chudaibypokie"),
            ],
            [
                InlineKeyboardButton("⚡𝐒𝚄𝙿𝙿𝙾𝚁𝚃 💕⚡", url="t.me/+OSWcMs68Zqo1YWQ1"),
            ],
            ]
...
async def clone(bot: app, msg: Message):
    ...
    try:
        ...
        await msg.reply(f" ᴊᴀ ʙᴇᴛᴀ ᴋʀ ғʏᴛ ᴄʟᴀssɪᴄ ᴋ ɴɪᴄʜᴇ ᴊʜʜᴜᴋ ᴋ ʀᴇʜɴᴀ ᴘᴅᴇɢᴀ 💥{user.first_name} 💨.")
